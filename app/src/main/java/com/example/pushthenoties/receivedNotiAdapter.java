...
public class receivedNotiAdapter extends RecyclerView.Adapter<receivedNotiAdapter.viewHolder> {

    ArrayList<receivedModel> data;
    Context context;

    public receivedNotiAdapter(ArrayList<receivedModel> data, Context context) {
        this.data = data;
